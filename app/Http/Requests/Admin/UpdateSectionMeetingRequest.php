...
class UpdateSectionMeetingRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $meeting && $this->user()->can('update', $meeting);
    }
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if ($section && ! in_array($section->term?->status, ['planned', 'active'], true)) {
                $validator->errors()->add('section_id', 'Meetings can only be updated when the term is planned or active.');
            }
