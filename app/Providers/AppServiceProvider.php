...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(ProgramEnrollment::class, \App\Policies\ProgramEnrollmentPolicy::class);
        Gate::policy(SectionEnrollment::class, \App\Policies\SectionEnrollmentPolicy::class);
        Gate::policy(Transcript::class, \App\Policies\TranscriptPolicy::class);
