...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/uni-hub/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/uni-hub/public/storage','logging.default','logging.deprecations.channel',
...
'session.secure','session.http_only','session.same_site','session.partitioned','inertia.ssr.enabled',
'inertia.ssr.url','inertia.ssr.ensure_bundle_exists','inertia.ensure_pages_exist','inertia.page_paths','inertia.page_extensions',
'inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','sanctum.stateful',
...
'role_or_permission','acts_on_branch','ensure_user_role',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','dashboard','profile.edit',
'profile.update','profile.destroy','admin.dashboard','admin.branches.index','admin.branches.store',
'admin.branches.update','admin.branches.destroy','admin.org-units.index','admin.org-units.store','admin.org-units.update',
'admin.org-units.destroy','admin.programs.index','admin.programs.store','admin.programs.update','admin.programs.destroy',
'admin.curricula.index','admin.curricula.store','admin.curricula.update','admin.curricula.destroy','admin.curricula.requirements.store',
'admin.curricula.requirements.update','admin.curricula.requirements.destroy','admin.api.metrics','admin.api.activities','admin.api.quick-actions',
'admin.terms.bulk-status','admin.terms.index','admin.terms.create','admin.terms.store','admin.terms.edit',
'admin.terms.update','admin.terms.destroy','admin.courses.index','admin.courses.create','admin.courses.store',
'admin.courses.show','admin.courses.edit','admin.courses.update','admin.courses.destroy','admin.courses.outcomes.store',
'admin.courses.outcomes.update','admin.courses.outcomes.destroy','admin.courses.prerequisites.store','admin.courses.prerequisites.destroy','admin.demo.index',
'admin.demo.flash-alert','admin.universities.index','admin.universities.store','admin.universities.update','admin.universities.destroy',
'admin.departments.index','admin.requirements.index','admin.students.index','admin.faculty.index','admin.staff.index',
'admin.enrollments.index','admin.users.index','admin.roles.index','admin.settings.index','admin.audit-logs.index',
'admin.tools.import','admin.tools.export','admin.tools.health','front_office.dashboard','lecturer.dashboard',
'lab_manager.dashboard','student.dashboard','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'app','errors.403','errors.404','errors.419','errors.429',
'errors.500','errors.503','errors.friendly','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
'laravel-exceptions-renderer::components.copy-button','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header','laravel-exceptions-renderer::components.icons.chevron-down','laravel-exceptions-renderer::components.icons.chevron-up',
...
'laravel-exceptions-renderer::components.theme-switcher','laravel-exceptions-renderer::components.trace','laravel-exceptions-renderer::components.trace-and-editor','laravel-exceptions-renderer::markdown','laravel-exceptions-renderer::show',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','UNITE_ENABLED',
'UNITE_ENFORCE','UNITE_FILTER_LISTS','UNITE_LOG_DECISION_DIFFS','UNITE_LOG_OBSERVATIONS','UNITE_CACHE_PREFIX',
'UNITE_CACHE_TTL','UNITE_CACHE_VERSION_KEY',);
